...
def dual_solar_Energy_calc(axis_tilt, axis_azimuth,
    ...
    # Calculate the POA (Plane of Array) irradiance for the dual-axis tracker
    poa = pvlib.irradiance.get_total_irradiance(
        solar_zenith, solar_azimuth, dni=dni, dhi=dhi, ghi=ghi,solar_zenith=solar_zenith,solar_azimuth=solar_azimuth
    )
